...
code[126] = op("OP_CAT", 126, opfns.disabled_maker("OP_CAT disabled"))
code[127] = op("OP_SUBSTR", 127, opfns.disabled_maker("OP_SUBSTR disabled"))
code[128] = op("OP_LEFT", 128, opfns.disabled_maker("OP_LEFT disabled"))
code[129] = op("OP_RIGHT", 129, opfns.disabled_maker("OP_RIGHT disabled"))

code[130] = op("OP_SIZE", 130, opfns.opt_size)
code[131] = op("OP_INVERT", 131, opfns.disabled_maker("OP_INVERT disabled"))
code[132] = op("OP_AND", 132, opfns.disabled_maker("OP_AND disabled"))
code[133] = op("OP_OR", 133, opfns.disabled_maker("OP_OR disabled"))
code[134] = op("OP_XOR", 134, opfns.disabled_maker("OP_XOR disabled"))
...
code[141] = op("OP_2MUL", 141, opfns.disabled_maker("OP_2MUL disabled"))
code[142] = op("OP_2DIV", 142, opfns.disabled_maker("OP_2DIV disabled"))
...
code[149] = op("OP_MUL", 149, opfns.disabled_maker("OP_MUL disabled"))
code[150] = op("OP_DIV", 150, opfns.disabled_maker("OP_DIV disabled"))
code[151] = op("OP_MOD", 151, opfns.disabled_maker("OP_MOD disabled"))
code[152] = op("OP_LSHIFT", 152, opfns.disabled_maker("OP_LSHIFT disabled"))
code[153] = op("OP_RSHIFT", 153, opfns.disabled_maker("OP_RSHIFT disabled"))
...
code[158] = op("OP_NUMNOTEQUAL", 158, opfns.binary_arith_maker(lambda x,y: int(x != y)))
...
code[165] = op("OP_WITHIN", 165, opfns.ternary_arith_maker(lambda x,y,z: int(y <= x and x < z)))
